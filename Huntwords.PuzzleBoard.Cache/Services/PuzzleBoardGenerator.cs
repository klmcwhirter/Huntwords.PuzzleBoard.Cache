...
{
    public class PuzzleBoardGenerator : IGenerator<Huntwords.Common.Models.PuzzleBoard>
    {
        ...
        IIndex<string, IGenerator<string>> WordGenerators { get; }
        ...
        public Huntwords.Common.Models.PuzzleBoard Generate(params object[] options)
        {
            ...
            var rc = new Huntwords.Common.Models.PuzzleBoard
            {
            ...
            var words = GenerateWord(puzzle, Options);
        ...
        protected IList<string> GenerateWord(Puzzle puzzle, PuzzleBoardGeneratorOptions boardOptions)
        {
        ...
        private WordSolution PlaceWord(Huntwords.Common.Models.PuzzleBoard board, string word, bool verbose)
        {
        ...
        private void FillWithRandomLetters(Huntwords.Common.Models.PuzzleBoard board)
        {
        ...
        private bool ValidSolution(int retry, Huntwords.Common.Models.PuzzleBoard board, bool verbose)
        {
        ...
        private void WordCopyToBoard(string word, Huntwords.Common.Models.PuzzleBoard board, PuzzlePoint directionOffsets, int x, int y)
        {
        ...
        private bool WordWillFit(WordSolution solution, Huntwords.Common.Models.PuzzleBoard board, PuzzlePoint directionOffsets, int x, int y)
        {
            var rc = true;
